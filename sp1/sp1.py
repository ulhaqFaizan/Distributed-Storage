    ...
    with conn:
        ...
        while True:
            if metaque.empty():
                ...
                print('')
                print("Printing Uncomfirmed Transactions: ")
...
#     s.connect((HOST, PORT))
    print('Connected to storage provider: ',p)
    print('')
    ...
    for block in bchain.chain:
        chain_data.append(block.__dict__)
    global blockchain
    print("Blockchain received from SP: ", p)
    print({"length": len(chain_data),
                       "chain": chain_data,
                       "peers": list(peers)})
    print('')
    ...
    while True:
        ...
        print("Request from SP: ",junkdata)
        print('')
        # sending chain 
        data = pickle.dumps(blockchain)
        size = sys.getsizeof(data)
        ...
        if check == '1':
            ...
            #print(type(lblock))
            print("Lastblock received by SP: ", p )
            print(lblock.__dict__)
            print('')
